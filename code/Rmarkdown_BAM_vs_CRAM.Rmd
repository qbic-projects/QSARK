...
merged_preprocessing_reduced <- merged_preprocessing_formatted_all %>% 
...
storage_preprocessing_reduced_cumulative <- plot_cumulative_storage(merged_preprocessing_reduced, "/storage_preprocessing_reduced_cumulative.png")
storage_preprocessing_reduced_cumulative
```
...
#print(bytesto(65656201694422, 't'))
#print(bytesto(187347596690457, 't'))
```
