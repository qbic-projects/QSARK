...
Apparently we are 2 hours in front of whatever is happning with tower. So eith erI need to start the runs at 2 in the morning or very very early after getting up. Either way, need to repeat the experiments.

+------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------+---------------------+-----------------+-----------------+
| Name                               | Description                                                               | Tower ID                                                        | Parameters          | Resource config | estimated costs |
+====================================+===========================================================================+=================================================================+=====================+=================+=================+
| Germline Single sample             | Sarek 3.0 run, with optimised resource requests for CHC982, germline only | <https://tower.nf/user/friederike-hanssen/watch/4GLbIcExOdptqD> | \--tools strelka    |                 | 30\$            |
|                                    |                                                                           |                                                                 |                     |                 |                 |
|                                    |                                                                           |                                                                 | \--aligner bwa-mem2 |                 |                 |
|                                    |                                                                           |                                                                 |                     |                 |                 |
|                                    |                                                                           |                                                                 | \--input            |                 |                 |
...
|                                    |                                                                           |                                                                 | \--trace_dir        |                 |                 |
+------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------+---------------------+-----------------+-----------------+
|                                    | repeated above, no fusion mounts                                          | <https://tower.nf/user/friederike-hanssen/watch/23w0xAj2zFt6dd> | aligner: bwa        |                 |                 |
|                                    |                                                                           |                                                                 |                     |                 |                 |
|                                    | Date: 02/09/2022                                                          |                                                                 |                     |                 |                 |
|                                    |                                                                           |                                                                 |                     |                 |                 |
|                                    | Compute Env:                                                              |                                                                 |                     |                 |                 |
+------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------+---------------------+-----------------+-----------------+
| Germline Single sample, no QC      | sarek 3.0                                                                 |                                                                 |                     |                 | \>30\$          |
+------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------+---------------------+-----------------+-----------------+
| Somatic, One sample                | sarek 3.0 with fusion mounts                                              | <https://tower.nf/user/friederike-hanssen/watch/2FbKmtx7MA4JoP> | aligner: bwa        |                 | 60\$            |
+------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------+---------------------+-----------------+-----------------+
| Somatic, one sample, no QC         | sarek 3.0                                                                 |                                                                 |                     |                 | \>60\$          |
+------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------+---------------------+-----------------+-----------------+
| Germline Single sample             | sarek 2.7.2                                                               |                                                                 |                     |                 |                 |
+------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------+---------------------+-----------------+-----------------+
| Germline Single sample, no QC      | sarek 2.7.2                                                               |                                                                 |                     |                 |                 |
+------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------+---------------------+-----------------+-----------------+
| Somatic, One sample                | sarek 2.7.2                                                               |                                                                 |                     |                 |                 |
+------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------+---------------------+-----------------+-----------------+
| Somatic, one sample, no QC         | sarek 2.7.2                                                               |                                                                 |                     |                 |                 |
+------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------+---------------------+-----------------+-----------------+
| Germline only, interval optimised? | sarek 3.0                                                                 |                                                                 |                     |                 |                 |
+------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------+---------------------+-----------------+-----------------+
| Run for all 5 samples together?    |                                                                           |                                                                 |                     |                 |                 |
+------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------+---------------------+-----------------+-----------------+

## Record s3 storage usage

`aws s3 ls s3://qbic-bucket-us-east-1/scratch --recursive --summarize > folder_size_nonhuman.tsv`

`aws s3 ls C3://qbic-bucket-us-east-1/results_30_costs_germline/ --recursive --human-readable --summarize > result_size.tsv`
...
Costs by instance for a single germline sample (CHC892), run with sarek 3.0:
...
2.  Naming a bit ugly....
3.  How to combine plots for multiple aspects, -\> possibly adding more rows in the above facet wrap?
