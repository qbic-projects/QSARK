...
```{r echo=FALSE}
data_30_germline <- read.table(file = "../data/functional/germline/sarek_30/merged_30_germline.csv", sep = ',', header = TRUE) %>%
...
somatic_snvs_scatter <- plot_scatter(data_snvs_30_somatic, 'Sensitivity', 'Precision', "SNVs", "snvs_prec_recall_30_somatic.png")
somatic_snvs_fscore <- plot_score(data_snvs_30_somatic, 'F.measure', "Sarek 3.1.1 SNVS", "snvs_fscore_311_somatic.png")

plot_summary(somatic_snvs_scatter, somatic_snvs_fscore, "somatic_30_snvs_summary.png")
```
...
somatic_indels_scatter <- plot_scatter(data_indels_30_somatic, 'Sensitivity', 'Precision', "INDELs", "indels_prec_recall_30_somatic.png")
somatic_indels_fscore <- plot_score(data_indels_30_somatic, 'F.measure', "Sarek 3.1.1 INDELs", "indels_fscore_311_somatic.png")

plot_summary(somatic_indels_scatter, somatic_indels_fscore, "somatic_30_indels_summary.png")
```
